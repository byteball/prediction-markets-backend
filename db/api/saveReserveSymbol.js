...
exports.saveReserveSymbol = async function saveReserveSymbol(aa_address, asset) {
  ...
  await db.query(`UPDATE market_assets SET reserve_symbol=?, reserve_decimals=? WHERE aa_address=?`, [symbol !== undefined ? symbol : null, symbol !== undefined ? decimals : 0, aa_address]);
}